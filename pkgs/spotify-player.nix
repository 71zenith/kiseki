...
assert lib.assertOneOf "withAudioBackend" withAudioBackend [
  ...
  rustPlatform.buildRustPackage rec {
    ...
    src = fetchFromGitHub {
      owner = "aome510";
      repo = pname;
      rev = "9020dbf25049a540b62261d9223ee9ae13e9af4e";
      hash = "sha256-uVBLI8vD21vu0HkqhIBdWiIbwVtFnAvYVSnWQq+byoA=";
    };

    cargoHash = "sha256-0mv0X90E98PjVRgDsd99NpHyMDWJCQKSfFPag9ERBvE=";
