  ...
  programs.starship = {
    ...
    settings = {
      ...
      character = {
        ...
        error_symbol = "[λ](${config.lib.stylix.colors.withHashtag.base0C})";
      ...
      git_branch.format = "[$branch](${config.lib.stylix.colors.withHashtag.base0A})";
      git_state.style = config.lib.stylix.colors.withHashtag.base0D;
      git_status.format = "[$all_status$ahead_behind](${config.lib.stylix.colors.withHashtag.base0B}) ";
      git_status.stashed = "";

      nix_shell.format = "[$state](${config.lib.stylix.colors.withHashtag.base0F}) ";

      cmd_duration.format = "[$duration](${config.lib.stylix.colors.withHashtag.base08})";
